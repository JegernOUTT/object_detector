...
from object_detector.modelling.abstract import AbstractModel, BaseModelParams
...
class DLA(AbstractModel):
    def __init__(self, levels, channels, params: BaseModelParams, num_classes=1000, block=BasicBlock,
        ...
        self._add_possible_output(self.level1, stride=2)

        self.level2 = Tree(levels[2], block, channels[1], channels[2], 2,
                           level_root=False,
                           root_residual=residual_root)
        self._add_possible_output(self.level2, stride=4)

        self.level3 = Tree(levels[3], block, channels[2], channels[3], 2,
                           level_root=True, root_residual=residual_root)
        self._add_possible_output(self.level3, stride=8)

        self.level4 = Tree(levels[4], block, channels[3], channels[4], 2,
                           level_root=True, root_residual=residual_root)
        self._add_possible_output(self.level4, stride=16)

        self.level5 = Tree(levels[5], block, channels[4], channels[5], 2,
                           level_root=True, root_residual=residual_root)
        self._add_possible_output(self.level5, stride=32)
